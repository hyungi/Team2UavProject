...
public class Noflyzone {
	...
	//이동경로가 no-fly-zone에 들어오는지 판단 여부 , 리턴값보다 zone의 반지름이 작은지 큰지에 따라 판단
    ...
    //시계 방향 돌면서 WP 찍기: nX=noflyzone X좌표, nY=noflyzone Y좌표, WP1(x1,y1), WP(x2,y2)
 	...
 	//반시계 방향 돌면서 WP 찍기: nX=noflyzone X좌표, nY=noflyzone Y좌표, WP1(x1,y1), WP(x2,y2)
